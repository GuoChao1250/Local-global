...
try
    ...
    mkdir(['C:\Users\USER\Contacts\Desktop\Globle MMN\sub\',name])        
    save(['C:\Users\USER\Contacts\Desktop\Globle MMN\sub\',name,'\react_num.mat'],'react_num')    
    save(['C:\Users\USER\Contacts\Desktop\Globle MMN\sub\',name,'\react_time.mat'],'react_time')
    WaitSecs(1)    
    Screen('Close',w);
    ShowCursor
catch
